...
"""
    for i in range(1, total_box + 1):
        ...
        batch = re.sub(r'^.*?-20\d{2}-', '', doc_name) if doc_name else ""
        ...
        if remarks:
            box_counter_fontsize = "36px"
            box_qty_fontsize = "26px"
        ...
        # QR column cells - nested table; rowspan grows when remarks are present
...
<div class="page-wrapper" style="{page_break_style}">
    <div class="label" style="border: none; padding: 0; height: 1.90in; box-sizing: border-box; overflow: hidden;">
        ...
        <table class="middle-table" style="height: {table_total_height}px;">
            <tr style="height: 26px;">
                <td class="item-column" rowspan="{table_rowspan}" style="width: {item_col_width}; vertical-align: top; padding: 4px; border-right: 1px solid #000;">
