...
class FinancialAuditDashboard {
	...
	setup_page() {
		...
		this.page.add_inner_button(this.lang === 'ar' ? 'البيانات' : 'Data', () => this.switch_view('data'));
	...
	switch_view(view) {
		...
		if (view === 'graph') {
			this.page.main.find('.graph-view-wrapper').show();
			this.page.main.find('.data-view-wrapper').hide();
		} else {
			this.page.main.find('.graph-view-wrapper').hide();
			this.page.main.find('.data-view-wrapper').show();

			if (!this.data_view_loaded) {
				this.load_data_view();
	...
	update_view_btn_state() {
		this.page.inner_toolbar.find('.fa-graph-btn').toggleClass('fa-view-active', this.current_view === 'graph');
		this.page.inner_toolbar.find('.fa-data-btn').toggleClass('fa-view-active', this.current_view === 'data');
	}
