...
frappe.pages['ptsr-live-monitor'].on_page_load = function (wrapper) {
    ...
    frappe.call({
        method: "teampro.teampro.page.ptsr_live_monitor.ptsr_live_monitor.get_ptsr_data_project_wise",
        callback: function (r) {
            if (r.message) {
                ...
                data.forEach((project) => {
                    ...
                    html += `
                        <tr>
                            <td colspan ="11" style="background-color: #add8e6;text-align:left">${project.name}</td>
                    ...
                    html += `
                        ...
                        <tr>
                            ...
                            <td rowspan="${project.tasks.length + 1}" onclick="makeEditable(this, '${project.name}', 'priority')" style="text-align:center;vertical-align:top;">
                                <span class="editable-span left-align">${project.priority || '-'}</span>
                            </td>
                            <td rowspan="${project.tasks.length + 1}" onclick="makeEditable(this, '${project.name}', 'remark')" style="text-align:center;vertical-align:top;min-width: 250px; max-width: 250px; word-wrap: break-word;">
                                <span class="editable-span left-align">${project.remark || '-'}</span>
                            </td>
                            <td rowspan="${project.tasks.length + 1}" onclick="makeEditable(this, '${project.name}', 'account_manager_remark')" style="text-align:center;vertical-align:top;min-width: 250px; max-width: 250px; word-wrap: break-word;">
                                <span class="editable-span left-align">${project.account_manager_remark || '-'}</span>
                            </td>
                            <td rowspan="${project.tasks.length + 1}" onclick="makeEditable(this, '${project.name}', 'custom_spoc_remark')" style="text-align:center;vertical-align:top;min-width: 250px; max-width: 250px; word-wrap: break-word;">
                                <span class="editable-span left-align">${project.custom_spoc_remark || '-'}</span>
                            </td>
                            <td rowspan="${project.tasks.length + 1}" onclick="makeEditable(this, '${project.name}', 'expected_value')" style="text-align: right; vertical-align: top;">
                                <span class="editable-span">${project.expected_value || '-'}</span>
                            </td>

                            <td rowspan="${project.tasks.length + 1}" onclick="makeEditable(this, '${project.name}', 'expected_psl')" style="text-align:center;vertical-align:top;">
                                <span class="editable-span left-align">${project.expected_psl || '-'}</span>
                            </td>
                            <td rowspan="${project.tasks.length + 1}" onclick="makeEditable(this, '${project.name}', 'sourcing_statu')" style="text-align:center;vertical-align:top;">
                                <span class="editable-span left-align">${project.sourcing_statu || '-'}</span>
                            </td>
                ...
                html += `
                    <tr style="font-weight:bold; background-color:#f0f0f0;">
                        <td colspan="11" class="left-align">Total</td>
                        <td>${total.vac || 0}</td>
                        <td>${total.sp || 0}</td>
                        <td>${total.fp || 0}</td>
                        <td>${total.sl || 0}</td>
