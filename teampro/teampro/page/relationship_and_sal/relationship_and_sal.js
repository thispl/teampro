...
.rec-i-split-left, .rec-i-split-right {
    ...
    $(wrapper).html(`
		...
		<div class="dashboard-wrapper" style="background-color: #F8FAFC">
            <div style="padding:10px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;style="background-color: #F8FAFC"">
                <!-- HEADING -->
                <div style="text-align:center;">
                    <h2 style="font-weight:bold;margin:0;">
                        R & S Dashboard
                    </h2>
                    <div id="current-datetime"style="font-size:16px;color:#666;margin-top:5px;">
                    </div>
                </div>
                <!-- FILTERS -->
                <div style="display:flex;gap:20px;align-items:center;justify-content:center;flex-wrap:wrap;padding:10px 12px;border-radius:8px;background:#fff;display:none;">
			...
			<div id="rec-i-metrics-cards" style="display:grid;grid-template-columns:repeat(6, 1fr);gap:10px;margin:30px 20px 0;padding:20px;border:1px solid #ebebeb;border-radius:12px;
                box-sizing:border-box;">
                            ...
                            <div class="dashboard-card empty-card1"></div>
                            <div class="dashboard-card empty-card-2"></div>
                        </div>	 

            <div style="display:flex;gap:5px;margin:20px;">
                <div class="rec-i-split-left">
                    <div class="dashboard-card opp-card"></div>
                    <div class="dashboard-card opp-am-card"></div>
                    <div class="dashboard-card empty-card"></div>
                    <div class="dashboard-card hr-card"></div>
                    <div class="dashboard-card it-card"></div>
                    <div class="dashboard-card tfp-card"></div>
                </div>
                <div class="rec-i-split-right">
                    <div class="dashboard-card active-card"></div>
                    <div class="dashboard-card inactive-card"></div>
                    <div class="dashboard-card interested-card"></div>
                    <div class="dashboard-card replied-card"></div>
                    <div class="dashboard-card open-card"></div>
                    <div class="dashboard-card lead-card"></div>
                </div>
        </div>
...
`);
    ...
    function renderSimpleCard(
        ...
        <div class="card-body" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-start;text-align:center;padding:18px 15px;box-sizing:border-box;">
            ...
            <div style="font-size:12px;color:#7a7a7a;margin-top:8px;line-height:1.4;text-align:center;display:flex;align-items:center;justify-content:center;width:100%;padding:0 10px;">
                ${subtitle}
            </div>
    ...
    function renderSimpleCardSmall(
        ...
        <div class="card-body" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-start;text-align:center;padding:10px 8px;box-sizing:border-box;">
            ...
            <div class="card-title" style="font-size:11px;font-weight:600;margin-bottom:4px;color:#24344d;">
                ${label}
            </div>

            <div class="card-value" style="color:${color};line-height:1;font-size:18px;font-weight:bold;">
                ${value}
            </div>
