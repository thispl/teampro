frappe.pages['ptis-monitor'].on_page_load = function(wrapper) {
	var page = frappe.ui.make_app_page({
		parent: wrapper,
		title: 'PTIS Live Report',
		single_column: true
	});
	...
	let html = `
        <table class="table table-bordered">
            <thead>
                <!-- First Row for Title -->
                <tr>
                    <th colspan="10" style="background: #4c3b69; color: white; text-align: center; font-size: 18px;">
                        PROJECT - TASK - ISSUE - STATUS - MONITOR
                    </th>
                </tr>
                <!-- Second Row for Date -->
                <tr>
                    <th colspan="7" style="background: #4c3b69; color: white; text-align: center;">Project Details</th>
...
function fetch_report_data() {
    frappe.call({
        method: "teampro.teampro.page.ptis_monitor.ptis_monitor.ptis_live_report",
        callback: function(r) {
            if (r.message) {
